...
namespace Common
{
    ...
    public class Evader
    {
        ...
        public Evader(out Menu _evade, EvadeMethods method = EvadeMethods.None, Spell spl = null)
        {
            ...
            Game.PrintChat("<font color='#ff3232'>Yuu's Vayne 2017: </font><font color='#d4d4d4'>Evader loaded! by Yuu </font>", ObjectManager.Player.ChampionName);
            Game.PrintChat(string.Format("<font color='#ff3232'>Yuu's Vayne 2017 - </font><font color='#d4d4d4'>Assembly Version: </font><font color='#ff3232'><b>{0}</b></font> ", typeof(Program).Assembly.GetName().Version));
        }
