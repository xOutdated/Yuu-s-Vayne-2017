...
namespace Ece_Vayne_2017.Champion
{
    public class Vayne : BaseChamp
    {
        ...
        public override void CreateConfigMenu()
        {
            ...
            Config.AddItem(new MenuItem("masterracec0mb0", "                      Yuu's Mode"));
            Config.AddItem(new MenuItem("condemn.style", "Condemn Method").SetValue(new StringList(new[] { "Yuu", "Asuna(LS)", "360" })));
